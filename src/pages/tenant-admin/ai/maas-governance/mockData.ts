...
export const mockSubscriptionsList: SubscriptionListItem[] = [
  ...
  },
  {
    ...
    name: 'NSB lightweight access',
    resourceName: 'nsb-lightweight-access',
    description: 'Mistral 7B for North Summit Bank teams.',
    phase: 'Active',
    priority: 8,
    groups: ['data-science-team', 'ml-engineers'],
    models: [IDS.mistral],
    tokenLimits: {
      ...
      // Parked Titan limits — restore with IDS.titan when Titan is back on MaaS governance.
      // [IDS.titan]: [
...
export const mockAuthPoliciesList: AuthPolicyListItem[] = [
  {
    ...
    description: 'Authorization for Granite and Mistral on North Summit Bank.',
    phase: 'Active',
    groups: ['data-science-team', 'ml-engineers', 'analytics-team'],
    models: [IDS.granite, IDS.mistral],
